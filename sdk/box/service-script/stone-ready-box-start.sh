...
su -c "psql -e -c  \"ALTER USER postgres WITH PASSWORD 'postgres' \"; " - postgres >> /root/cpw.txt
...
nohup pgweb --listen=4201 --url postgres://postgres:postgres@127.0.0.1:5432/postgres &
